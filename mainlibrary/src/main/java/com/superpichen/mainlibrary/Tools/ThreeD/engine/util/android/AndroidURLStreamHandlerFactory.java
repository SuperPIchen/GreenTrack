...
public class AndroidURLStreamHandlerFactory implements URLStreamHandlerFactory {
    ...
    public URLStreamHandler createURLStreamHandler(String protocol) {
        if ("assets".equals(protocol)) {
            return new com.superpichen.mainlibrary.Tools.ThreeD.engine.util.android.assets.Handler();
        } else if ("content".equals(protocol)){
            return new com.superpichen.mainlibrary.Tools.ThreeD.engine.util.android.content.Handler();
        }
        return null;
    }
}

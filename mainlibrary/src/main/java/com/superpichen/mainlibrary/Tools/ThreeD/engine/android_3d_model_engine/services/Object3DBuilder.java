package com.superpichen.mainlibrary.Tools.ThreeD.engine.android_3d_model_engine.services;
		...
		if (materials != null && !faceMats.isEmpty()) {
			...
			for (int i = 0; i < faces.getSize(); i++) {
                ...
                if (materialName != null) {
					...
					WavefrontLoader.Material mat = materials.getMaterial(materialName);
					if (mat != null) {

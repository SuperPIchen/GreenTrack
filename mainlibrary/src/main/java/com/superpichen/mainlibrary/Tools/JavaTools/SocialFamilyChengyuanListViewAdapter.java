...
public class SocialFamilyChengyuanListViewAdapter extends BaseAdapter {
    private Context context;
    private List<SocialFriendInfo> data;

    public SocialFamilyChengyuanListViewAdapter(Context context, List<SocialFriendInfo> data) {
        this.context = context;
        this.data = data;
    }

    public SocialFamilyChengyuanListViewAdapter() {
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.TvItemSocialSendInvite.setText("关注出行");
        holder.TvItemSocialSendInvite.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(finalHolder.TvItemSocialSendInvite.getText().toString().equals("关注出行")){
                    finalHolder.TvItemSocialSendInvite.setText("取消关注");
                }else {
                    finalHolder.TvItemSocialSendInvite.setText("关注出行");
                }
